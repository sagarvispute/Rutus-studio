...
export default function Navbar() {
  ...
  return (
    <div className="container m-auto flex md:justify-between items-center py-3 flex-wrap flex-[2_2_0%] relative bg-white">
      <a href="" className='basis-[134px] md:basis-auto'><img src="images/Logo.webp" alt="" className='h-12 w-auto' /></a>
      ...
      <div className='flex gap-1 basis-[calc(100%-134px)] md:basis-0 justify-end order-2 md:order-3'>
        ...
        <a href="/contact" className='rounded-full border-2 border-black flex gap-3 py-1 px-5 items-center group'>
          <span className='hidden md:inline'>Contact</span><span className='text-xl -rotate-[50deg] group-hover:-rotate-0 ease-in-out duration-100'><IoArrowForward /></span>
          </a>
      </div>
    </div>
  )
